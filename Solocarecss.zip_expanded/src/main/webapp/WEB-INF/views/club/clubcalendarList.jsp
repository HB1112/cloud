...
<body>
    <div class="container">
        <div class="header">
            ...
            <button class="add-event-btn" onclick="location.href='${pageContext.request.contextPath}/club/${clubNum}/clubcalendar/add'">
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventClick: function(info) {
                ...
                document.getElementById('edit-btn').onclick = function() {
                    window.location.href = 'edit/' + eventTitle; // 수정 페이지로 이동
                };

                document.getElementById('delete-btn').onclick = function() {
                    if (confirm('정말 삭제하시겠습니까?')) {
                        window.location.href = 'delete/' + eventTitle; // 삭제 요청
                    }
                };
